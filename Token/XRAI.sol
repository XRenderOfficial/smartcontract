...
contract XRenderAI is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;
    uint256 private _maxCap = 100000000000 * 10 ** decimals();

    bool public isAntiBot;
    uint256 public maxBuy = 100000000000 * 10 ** decimals();
    uint256 public maxSell = 100000000000 * 10 ** decimals();
    ...
    constructor() ERC20("XRender AI", "XRAI") {
